...
export function EqListenBar({
  ...
  return (
    <div className="rounded-2xl border border-line/80 bg-panel p-5 shadow-[var(--surface-shine)]">
      <div className="flex flex-wrap items-center gap-4">
        <button
          ...
          className="inline-flex size-12 shrink-0 items-center justify-center rounded-full bg-accent text-on-accent shadow-[var(--glow-accent-strong)] transition duration-150 hover:bg-accent-dim disabled:cursor-not-allowed disabled:opacity-40 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
